// AlgoZenith — Convex Polygon Triangulation
// 2024-07-23 16:43
// Problem Link: https://maang.in/problems/Convex-Polygon-Triangulation-200?resourceUrl=cs99-cp522-pl3619-rs200
...
public class Main {
    ...
    private static long rec(int l, int r) {
        ...
        for (int i = l + 1; i <= r - 1; i++) {
            long temp = v[l] * 1L * v[i] * v[r];
            temp += rec(l, i) + rec(i, r);
